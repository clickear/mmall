...
import com.mmall.dao.ScheduleJobMapper;
import com.mmall.pojo.ScheduleJob;
import com.mmall.support.quartzjob.QuartzJobFactory;
import com.mmall.support.quartzjob.QuartzJobFactoryDisallowConcurrentExecution;
...
@Service("iJobTaskService")
public class JobTaskServiceImpl implements IJobTaskService{
    private org.slf4j.Logger log = LoggerFactory.getLogger(JobTaskServiceImpl.class);
